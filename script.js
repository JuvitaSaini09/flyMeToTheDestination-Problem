...
/*
1) If 
     check in if whether the first element is zero or not and if it is 0 then return -1;
2)Else 
       a)  initialise variables: fuelAirportsArrLength for length of the array ,flightCount as 0 to track the number of jumps or flights,leftAirport and rightAirport to keep track of the starting and max reachable index in array for current iteration
